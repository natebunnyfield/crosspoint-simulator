...
CAP_BEARING_ADJ = {
    'A': (CAP_A_LSB,  -11), 'B': ( -11,  -51), 'C': (  -4,  -98), 'D': ( -14,  -42),
    'E': ( -65,  -80), 'F': ( -11,  -79), 'G': (  -2,  -75), 'H': ( -12, -103),
    'I': (  13,  -98), 'J': (-104,  -88), 'K': ( -13,  -78), 'L': ( -14,  -34),
    'M': ( -18, -100), 'N': ( -12,  -97), 'O': (  21,  -55), 'P': ( -14,  -81),
    'Q': (  -2,  -22), 'R': ( -36, CAP_R_RSB), 'S': (  22,  -32), 'T': (  87,  -80),
    'U': (   0, CAP_U_RSB), 'V': (  23,  -88), 'W': (  49, CAP_W_RSB), 'X': (  -7,  -73),
    'Y': (CAP_Y_LSB, CAP_Y_RSB), 'Z': (  -6,  -97),
}
