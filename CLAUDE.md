...
| Ink: Corner Rounding · Ink: Spread · Ink: Impression · Ink: Squeeze · Ink: Deboss Shadow · Ink: Plate Pressure | one `PSSliderSpecifier` each, 0..200, the only sliders in the bundle; six groups because a slider has no title of its own. Ship 45 / 55 / 100 / 100 / 100 / 100 (owner 2026-09-12) |
